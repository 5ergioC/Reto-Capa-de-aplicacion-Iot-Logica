...
ALLOWED_HOSTS = ["localhost", "107.22.151.129"]
...
DATABASES = {
    "default": {
        ...
        "HOST": "44.202.251.95",  # Dirección IP de la base de datos
...
# Configuracion del nuevo evento para la pantalla OLED del NodeMCU.
OLED_EVENT_WINDOW_MINUTES = 60
OLED_EVENT_TEMP_THRESHOLD = 28.0
OLED_EVENT_HUMIDITY_THRESHOLD = 70.0
